...
public class FunctionNode implements Callable {
    ...
    private final Environment<String, Object> environment;

    public FunctionNode(String name, String returnType, List<Statement> body, Environment<String, Object> environment) {
        this.name = name;
