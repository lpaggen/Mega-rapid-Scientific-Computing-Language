...
public abstract class BuiltInFunctionNode extends FunctionNode {
    public BuiltInFunctionNode(String name, TokenKind returnType, List<Statement> arguments, Environment env) {
        super(name, returnType, arguments, List.of(), env);
    }

    public abstract void executeWithArgs(Environment env, List<Object> args);
}
