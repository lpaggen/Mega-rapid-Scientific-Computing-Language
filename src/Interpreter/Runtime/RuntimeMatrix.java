...
public final class RuntimeMatrix implements MatrixLike {
    ...
    @Override
    public int length() {
        throw new UnsupportedOperationException("RuntimeMatrix does not support length(). Use rows() and cols() instead.");
    }

    @Override
    public Expression get(int index) {
        throw new UnsupportedOperationException("RuntimeMatrix does not support single index access. Use get(row, col) instead.");
    }

    @Override
    public void set(int index, Expression element) {
        throw new UnsupportedOperationException("RuntimeMatrix does not support single index access. Use set(row, col, element) instead.");
    }
    ...
    public void setRow(int row, int startCol, MatrixLike newRow) {
        if (newRow.cols() + startCol > numCols) {
            throw new RuntimeException("New row exceeds RuntimeMatrix dimensions.");
        }
